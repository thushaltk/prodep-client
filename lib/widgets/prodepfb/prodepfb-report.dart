...
class Prodepfbreport extends StatefulWidget {
  static const routeName = "/prodepfb-report";
  const Prodepfbreport({Key? key}) : super(key: key);

  @override
  State<Prodepfbreport> createState() => _ProdepfbreportState();
}

class _ProdepfbreportState extends State<Prodepfbreport> {
  ...
  initialise() async {
    prodepFBService = ProdepFBService();
    prodepFBService.initialise();

    await prodepFBService.getAllFBData().then((value) {
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Prodepfbcountcard(sentimentValue: positiveCount, sentimentType: "POSITIVE"),
                        Prodepfbcountcard(sentimentValue: negativeCount, sentimentType: "NEGATIVE")
                      ],
                    )
                  ],
                ),
