...
class Prodeptweetchart extends StatefulWidget {
  final String username;
  final String date;
  final int positiveCount;
  final int negativeCount;

  const Prodeptweetchart(
      {super.key,
  ...
  @override
  State<StatefulWidget> createState() => ProdeptweetchartState();
}

class ProdeptweetchartState extends State<Prodeptweetchart> {
  int touchedIndex = -1;
        ...
        child: Row(
          children: <Widget>[
            ...
            Column(
              ...
              children: [
                Icon(FontAwesomeIcons.twitter, color: Colors.blue, size: 70,),
                Column(
