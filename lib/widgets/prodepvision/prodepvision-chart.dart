...
class Prodepvisionchart extends StatefulWidget {
  final String username;
  final String date;
  final int positiveCount;
  final int negativeCount;

  const Prodepvisionchart(
      {super.key,
  ...
  @override
  State<StatefulWidget> createState() => ProdepvisionchartState();
}

class ProdepvisionchartState extends State<Prodepvisionchart> {
  int touchedIndex = -1;
